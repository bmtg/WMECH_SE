...
(function()
 {
     ...
     function highlightSegments(event) {
         ...
         for (var seg in Waze.model.segments.objects) {
             ...
             if (false && showPlaces && attributes.roadType == 18) {
                 newColor = "#444";
                 newOpacity = 0.8;
                 newDashes = "4 12";
                 newWidth = 3;
     ...
     function highlightPlaces(event) {
         ...
         for (var mark in Waze.model.venues.objects) {
             ...
             // shopping center = more transparent
             // else if (categories.indexOf("SHOPPING_CENTER") > -1) {
             ...
             if (venue.attributes.lockRank < 2 && 
                 (categories.indexOf("JUNCTION_INTERCHANGE") > -1 ||
                  ...
                  categories.indexOf("CANAL") > -1 ||
                  categories.indexOf("PARKING_LOT") > -1 ||
                  categories.indexOf("RIVER_STREAM") > -1 ||
                  categories.indexOf("SEA_LAKE_POOL") > -1 ||
             ...
             if (showLocked && venue.attributes.lockRank > 2 && venue.isPoint() && categories.indexOf("COLLEGE_UNIVERSITY") > -1 ) {
                 poly.setAttribute("stroke", "red");
             }

             else if (showLocked && venue.attributes.lockRank > 3 && (categories.indexOf("HOSPITAL_MEDICAL_CARE") > -1 ||
